const en = {
  ...
  projectSettingsModal: {
    ...
    navigationLabel: 'Project settings navigation',
    ...
    inviteEmailLabel: 'Member email address',
    ...
    gitlabRepositoryLabel: 'GitLab repository URL',
    ...
    gitlabRemoveConfirm: 'Remove GitLab repository “{repository}”? Future pushes will no longer sync comments.',
    githubTitle: 'GitHub commit linking',
    githubDescription: 'Sync a push commit as a comment when its message contains an issue key.',
    githubPlaceholder: 'https://github.com/organization/repository',
    githubEmpty: 'No GitHub repositories configured yet.',
    githubSecretOnce: 'The secret is shown once. Paste it into the GitHub Webhook settings.',
    githubRepositoryLabel: 'GitHub repository URL',
    githubRemoveConfirm: 'Remove GitHub repository “{repository}”?',
    webhookUrl: 'Webhook URL',
    emailTitle: 'Email notifications',
    emailDescription: 'Send assignees a summary of due and overdue tasks.',
    dailySummary: 'Daily summary',
    dailySummaryDescription: 'Send assignees one daily summary of due and overdue issues.',
    ...
    errors: {
      ...
      emailLoadFailed: 'Email settings could not be loaded',
      emailSaveFailed: 'Email settings could not be saved',
      gitlabLoadFailed: 'GitLab repositories could not be loaded',
      gitlabAddFailed: 'GitLab repository could not be added',
      gitlabResetFailed: 'GitLab secret could not be reset',
      gitlabRemoveFailed: 'GitLab repository could not be removed',
