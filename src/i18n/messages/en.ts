const en = {
  ...
  projectSettingsModal: {
    ...
    gitlabTitle: 'GitLab commit linking',
    gitlabDescription: 'Add multiple GitLab projects. A Push commit mentioning a task key (for example, JLNX-123) is synced as a comment on that task.',
    gitlabPlaceholder: 'https://gitlab.example.com/group/repository',
    gitlabAdd: 'Add repository',
    gitlabAdding: 'Adding...',
    gitlabEmpty: 'No GitLab repositories configured yet.',
    gitlabResetToken: 'Reset Secret',
    gitlabDelete: 'Remove',
    gitlabTokenOnce: 'Secret token (shown once; paste it into this repository’s GitLab Webhook settings)',
    gitlabWebhookUrl: 'Webhook URL (shared by all configured repositories)',
    gitlabCopy: 'Copy',
  ...
  taskEditor: {
    ...
    copyTaskKey: 'Copy task identifier',
    taskKeyCopied: 'Task identifier copied',
    newIssue: 'New issue',
    issue: 'Issue',
    execution: 'Execution',
    time: 'Time',
