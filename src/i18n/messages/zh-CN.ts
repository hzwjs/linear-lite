const zhCN = {
  ...
  projectSettingsModal: {
    ...
    membersNav: '成员',
    piTitle: '本地 Pi Agent',
    piDescription: '为当前项目配置 Pi Agent 后即可将任务指派给它。每次配置都会轮换 Agent Token，Token 仅显示一次。',
    piProjectLabel: '当前项目',
    piConfigure: '配置 Pi',
    piReconfigure: '重新配置 Pi',
    piConfiguring: '配置中…',
    piConfigured: 'Pi Agent 已配置，请保存一次性 Token。',
    piStatusConfigured: '已配置',
    piStatusNotConfigured: '未配置',
    piStatusLoading: '检查中…',
    piTokenOnce: 'Agent Token 仅显示一次，请复制到本地 Pi Bridge 配置页。',
    integrationsNav: '集成',
    ...
    errors: {
      ...
      piConfigureFailed: '无法配置 Pi Agent',
      piStatusLoadFailed: '无法读取 Pi Agent 配置状态'
    },
    buttons: {
      save: '保存',
      saving: '保存中…'
  ...
  documents: {
    ...
    attachmentUploading: '正在上传附件 {name}…', attachmentUploadFailed: '附件 {name} 上传失败', deleteAttachment: '删除附件',
    attachmentDocumentMismatch: '该附件不属于当前文档，已阻止下载。',
    imageLoading: '图片加载中…', imageLoadFailed: '图片加载失败',
