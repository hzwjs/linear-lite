...
export interface ProjectCodexBinding { runnerId: number; repositoryId: number; baseBranch: string }
export const codexApi = {
  ...
  saveBinding(projectId: number, body: ProjectCodexBinding) { return api.put<ApiResponse<ProjectCodexBinding>>(`/projects/${projectId}/codex-binding`, body).then(unwrap) },
